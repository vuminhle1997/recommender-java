...
/**
 * Build a model for basic association rules. This class computes the
 * association for all pairs of items.
 */
    ...
    public AssociationModel get() {
        ...
        for (Long2ObjectMap.Entry<LongSortedSet> xEntry : itemUsers.long2ObjectEntrySet()) {
            ...
            for (Long2ObjectMap.Entry<LongSortedSet> yEntry : itemUsers.long2ObjectEntrySet()) {
                ...
                double numeratorFraction = (float) count;
                double denominatorFraction = (float) xUsers.size();
